<?php
  $title = "Conheça o projeto | Tinn-R";
  $description = "Conheça toda a história por trás do desenvolvimento do Tinn-R.";
  include('header.php');
?>
  <div class="section">
      ...
      <div class="row">
        ...
        <span class="">
          ...
          <div class="row center">
          	<a href="donation" class="btn waves-effect waves-light orange">Faça uma doação  <i class="fa fa-gift fa-2x"></i></a>
      	  </div>
        </span>
        </div>
      </div>
