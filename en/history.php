<?php
  $title = "The History | Tinn-R";
  $description = "Get to know the whole story behind the development of Tinn-R.";
  include('header.php');
?>
<div class="section">
      ...
      <div class="col m8 offset-m2 card">
        <span class="">
          ...
          <div class="row center">
            <a href="donation" class="btn waves-effect waves-light orange">Make a Donation  <i class="fa fa-gift fa-2x"></i></a>
          </div>
        </span>
      </div>
    </div>
