...
<head>
  ...
  <meta name="keywords" ="Tinn-R, Tinnr, R, IDE, statistic, editor, Text Processing, open source, free, biostatistics">
...
<body>
  ...
  <nav class="orange lighten-1" role="navigation">
    ...
    <a id="logo-container" href="/tinnr/en/" class="brand-logo white-text">Tinn-R</a>
      <ul class="right hide-on-med-and-down">
        <li><a class="white-text" href="/tinnr/en/">Home</a></li>
        ...
        <li><a class="white-text" href="donation">Donation<i class="fa fa-gift fa-2x right"></i></a></li>
      </ul>

      <ul id="nav-mobile" class="side-nav">
        <li><a  href="/tinnr/en/">Home</a></li>
        <li><a  href="about">About</a></li>
        <li><a  href="download">Download</a></li>
        <li><a  href="https://groups.google.com/forum/?hl=en#!forum/tinn-r">Forum<i class="fa fa-external-link right"></i></a></li>
        <li><a  href="donation">Donation<i class="fa fa-gift fa-2x right"></i></a></li>
        <li><a class="subheader center">Language</a></li>
